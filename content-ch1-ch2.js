...
/* ====== 碎镜 章节1/2 · 手机界面样式 ====== */
.screen.sm-screen{display:none;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;min-height:100dvh;padding:8px;position:relative;background:radial-gradient(ellipse at 50% 30%,#15171f,#06070b 75%);}
